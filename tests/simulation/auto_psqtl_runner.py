...
# Automation script for running psQTL on data simulated by the
# simulate_genotype_calls.py script.
...
def main():
    genomeFile = "genome.fasta" # as generated by simulate_genotype_calls.py
    psqtlDir = "/home/stewarz2/scripts/psQTL" # set this to the location where the GitHub repo was cloned
